...
public:
    ...
    virtual void displayInfo() const; // MARK: polymorphism
...
class Tablet : public Medicine // MARK: inheritance
{
public:
...
class Syrup : public Medicine // MARK: inheritance
{
public:
...
public:
    ...
    Shop();
    Shop(string shopName);   // MARK: constructor overloading
    Shop(const Shop &other); // MARK: copy constructor
